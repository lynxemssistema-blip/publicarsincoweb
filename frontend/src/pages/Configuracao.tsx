...
export default function ConfiguracaoPage() {
 ...
 const [maxRegistrosCustom, setMaxRegistrosCustom] = useState<string>('');
  const DEFAULT_SECTOR_LIMITS: Record<string, number> = {
    corte: 500,
    dobra: 500,
    solda: 500,
    pintura: 500,
  ...
  <div className="mt-8 border-t border-gray-100 pt-6">
    <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-4 gap-2">
      ...
      <button 
        ...
        className="flex items-center gap-1.5 bg-[#32423D] text-[#E0E800] px-3 py-1.5 rounded-lg text-xs font-bold hover:bg-[#2a3833] transition-colors shadow-sm shrink-0"
      >
