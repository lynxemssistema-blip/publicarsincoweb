...
export default function LoginAcessoPage({ onAuthSuccess }: LoginAcessoProps) {
 ...
 >
 <div className="bg-white/10 p-3 rounded-md border border-white/10 shadow-lg">
 ...
 <div className="bg-[#32423D] p-4 rounded-md shadow-md mb-4">
 ...
 className="flex flex-col items-center justify-center p-10 bg-green-50 rounded-md border border-green-100"
 >
 ...
 <input
 type="text"
 className="w-full pl-14 pr-4 py-3.5 bg-gray-50 border border-gray-200 rounded-md focus:border-[#32423D] focus:ring-2 focus:ring-[#E0E800]/30 outline-none transition-all placeholder:text-gray-400 font-medium text-gray-800 shadow-sm"
 ...
 type="submit"
 disabled={loading}
 className="w-full py-3.5 bg-[#32423D] hover:bg-[#2a3833] text-white rounded-md font-bold text-lg shadow-lg shadow-[#32423D]/20 hover:shadow-xl transition-all active:scale-[0.98] disabled:opacity-70 disabled:scale-100 flex items-center justify-center gap-3 overflow-hidden relative group"
 >
