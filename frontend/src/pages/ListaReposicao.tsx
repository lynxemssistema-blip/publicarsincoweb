...
export default function ListaReposicaoPage() {
 ...
 {/* Tabela Esquerda */}
 <div className={`flex-1 bg-white border border-slate-200 rounded-md overflow-hidden flex flex-col min-h-0 shadow-sm transition-all duration-300 ${selectedItem ? 'lg:w-[65%]' : 'w-full'}`}>
 ...
 {selectedItem && (
 <div className="w-full lg:w-[35%] bg-white border border-slate-200 rounded-md shadow-lg flex flex-col p-4 animate-in slide-in-from-right-4 duration-300 absolute lg:relative inset-y-0 right-0 z-30 lg:z-10">
 ...
 <div className="fixed inset-0 bg-slate-900/40 z-[100] flex items-center justify-center p-4 shadow-2xl animate-in fade-in zoom-in-95 duration-200">
 <div className="bg-white rounded-md shadow-2xl w-full max-w-sm overflow-hidden flex flex-col border border-slate-200">
