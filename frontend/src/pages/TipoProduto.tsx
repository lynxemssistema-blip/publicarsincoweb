...
export default function TipoProdutoPage({ isModal = false, onCloseModal }: Props = {}) {
            ...
            <div className="flex items-center justify-between p-5 border-b border-gray-100">
              <div className="flex items-center gap-3">
                ...
                <h2 className="text-lg font-semibold text-[#32423D]">
                  {isEditing ? 'Editar Tipo Produto' : 'Novo Tipo'}
                </h2>
              </div>
              <button
                onClick={resetForm}
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label className="block text-xs font-medium text-gray-600 mb-1">
                    Tipo Produto <span className="text-red-500 font-bold">*</span>
                  </label>
                  <input
                    type="text"
                    name="TipoProduto"
                ...
                <div>
                  <label className="flex items-center justify-between text-xs font-medium text-gray-500 mb-0.5">
                    Unidade Medida
                    <button type="button" onClick={() => setShowUnidadeModal(true)} className="text-[#03624C] hover:text-[#0b3a2d] hover:bg-[#eaf4f1] rounded p-0.5 transition-colors" title="Nova Unidade">
 ...
 <p className="text-gray-500 text-xs">Gerencie os tipos de produto para KPI</p>
 </div>
 ...
 <th className="px-2 py-0.5 text-left text-xs font-semibold text-white uppercase tracking-wider">Tipo Produto</th>
 <th className="px-2 py-0.5 text-left text-xs font-semibold text-white uppercase tracking-wider w-24">Unidade</th>
 ...
 <p className="text-xs">Nenhum tipo de produto encontrado</p>
 </div>
 </td>
 </tr>
 ) : (
 ...
 Mostrando <span className="font-medium">{filteredItems.length}</span> de <span className="font-medium">{items.length}</span> tipos
 </p>
 </div>
 )}
 </div>
