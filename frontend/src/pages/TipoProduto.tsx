                                    ...
                                    <tr>
                                        <td colSpan={5} className="px-4 py-12 text-center">
                                            <div className="flex flex-col items-center gap-3 text-gray-400">
                                                ...
                                                <p className="text-sm">Nenhum tipo de produto encontrado</p>
                                            </div>
                                        </td>
                                    </tr>
                                ) : (
                                        ...
                                        >
                                            ...
                                            <td className="px-4 py-3">
                                                <div className="flex items-center gap-3">
                                                    ...
                                                    <span className="text-sm font-medium text-gray-900">{item.TipoProduto}</span>
                                                </div>
                                            </td>
                                            <td className="px-4 py-3 text-sm text-gray-600">{item.Unidade || '-'}</td>
                                            <td className="px-4 py-3 text-sm text-gray-600 truncate max-w-[300px]">{item.Descricao || '-'}</td>
                                            <td className="px-4 py-3">
