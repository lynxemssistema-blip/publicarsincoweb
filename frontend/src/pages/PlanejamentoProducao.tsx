    ...
    return (
        <div className={`h-full flex flex-col ${fromGlobal ? 'p-2 md:p-3 lg:p-4' : ''}`}>
            ...
            <div className="bg-white dark:bg-card border-b border-gray-100 p-2 shadow-sm shrink-0 z-10 flex flex-col gap-2">
                ...
                {fallbackMsg && (
                    <div className="bg-amber-50 text-amber-800 px-4 py-3 rounded-lg border border-amber-200 text-sm font-medium animate-in fade-in slide-in-from-top-4 mt-4">
                        {fallbackMsg}
                    </div>
                )}
            ...
            <div className="flex-1 overflow-y-auto p-3 space-y-4 bg-gray-50/30">
                {loading ? (
                    ...
                    Object.keys(groupedByOS).map((osId) => {
                        ...
                        return (
                            <div key={osId} className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden mb-4">
                                {/* OS Header */}
                                <div className="bg-gray-50 px-4 py-3 border-b border-gray-200 flex justify-between items-center sticky top-0 z-0">
                                    <div className="flex items-center gap-3">
