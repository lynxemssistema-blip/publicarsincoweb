...
router.get('/:id/relatorio/excel', async (req, res) => {
    try {
        ...
        const [itemRows] = await pool.execute(
            `SELECT i.IdOrdemServicoItem, i.IdMaterial, i.CodMatFabricante as CodDesenhoProduto, i.DescResumo as DescricaoProduto, i.qtde as Qtde, i.Fator, i.Peso as PesoTotal,
        ...
        sheet.addRow(['Projeto:', `${os.Projeto} - ${os.ProjetoDescricao || ''}`, '', '', 'Data Emissão:', formatBR(new Date())]);
        ...
        <body>
            <div class="header">
                ...
                <div class="header-right">
                    <div><strong>Data de Emissão:</strong><br>${formatBR(new Date())}</div>
                </div>
            </div>
